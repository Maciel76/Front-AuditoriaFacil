...
- `ColaboradorPortal.vue` agora aquece as imagens das conquistas desbloqueadas logo apos receber `metricas/portal/me`, usando preload com cache em `utils/media.js`; o destaque da home e o modal de detalhes recebem prioridade alta (`fetchpriority="high"`) para reduzir atraso perceptivel no primeiro paint.
